  ...
  return (
    <>
      <style>{`
        ...
        .kpi-card { transition: border-color 0.15s, box-shadow 0.15s; }
        .kpi-card:hover { border-color: #999 !important; box-shadow: 0 2px 8px rgba(0,0,0,0.08) !important; }
      ...
      <div style={{
        ...
        {loading ? (
          <div style={{ ...card, padding: '28px 24px' }}>
            ...
            <p style={{ fontSize: '12px', color: '#CCC', margin: '0 0 0 24px' }}>
          ...
          <>
            ...
            <div style={{
              ...
              {kpis.map(({ label, value, sub, Icon, gold }) => (
                <div key={label} className="kpi-card" style={{ ...card, padding: isMobile ? '16px 14px' : '20px 18px' }}>
                  <div style={{
            ...
            <div style={{
              ...
              {/* Lead Sources */}
              <div style={{ ...card, padding: isMobile ? '18px 16px' : '22px 20px' }}>
                ...
                {stats.total === 0 ? (
                  ...
                  sources.map((s, i) => (
                    <div key={s.name} style={{
                      ...
                      <div style={{ flex: 1, background: '#F0F0F0', borderRadius: '2px', height: '3px' }}>
                        <div style={{
                ...
                {analyses.length === 0 ? (
                  ...
                  analyses.slice(0, 5).map((a, i) => (
                    <div key={a.id} className="analysis-row" style={{
                      ...
                      <p style={{ margin: 0, fontSize: '11px', color: '#BBBBBB', letterSpacing: '-0.1px' }}>
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: GOLD, border: `1px solid ${GOLD}33`,
